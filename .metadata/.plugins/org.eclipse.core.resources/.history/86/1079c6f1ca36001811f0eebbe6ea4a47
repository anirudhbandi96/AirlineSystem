...
Enter Password : <input type='text' id='#' name='password'> <br>
...
<input type = "radio" name = "manager_selected_option" class="radio-custom"  id = "chk1" onclick="javascript:Check1();" value="flight_Status"/><label for="chk1" class="radio-custom-label">List of all customers who have seats reserved on a given flight </label> <br>
